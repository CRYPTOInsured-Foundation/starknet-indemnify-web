...
//           <Badge className={`${getStatusColor(proposal.proposalStatus)} text-white px-3 py-1`}>
//             {proposal.proposalStatus}
//           </Badge>
//         </div>
//       </header>
...
//               <p className="text-gray-500 text-sm">Risk Analytics Approval:</p>
//               <div className="flex items-center gap-2 mt-1">
//                 {getApprovalBadge(proposal.riskAnalyticsApproved)}
//               </div>
//             </div>
...
//               <p className="text-gray-500 text-sm">Governance Approval:</p>
//               <div className="flex items-center gap-2 mt-1">
//                 {getApprovalBadge(proposal.governanceApproved)}
//               </div>
//             </div>
//           </CardContent>
//         </Card>
...
//           <Badge className={`${statusColor} text-white px-3 py-1`}>
//             {proposal.proposalStatus}
//           </Badge>
//         </div>
//       </header>
...
//               <p className="text-gray-500 text-sm">Risk Analytics Approval:</p>
//               <div className="flex items-center gap-2 mt-1">
//                 {getApprovalBadge(proposal?.riskAnalyticsApproved ?? "PENDING")}
//               </div>
//               {proposal.riskAnalyticsRemarks && (
//                 <p className="text-sm mt-1 text-gray-600">
//                   {proposal.riskAnalyticsRemarks}
//                 </p>
//               )}
//               {proposal.riskAnalyticsAt && (
//                 <p className="text-xs text-gray-400 mt-1">
//                   {new Date(proposal.riskAnalyticsAt).toLocaleString()}
//                 </p>
//               )}
//             </div>
...
//               <p className="text-gray-500 text-sm">Governance Approval:</p>
//               <div className="flex items-center gap-2 mt-1">
//                 {getApprovalBadge(proposal.governanceStatus || "PENDING")}
//               </div>
//               {proposal.governanceRemarks && (
//                 <p className="text-sm mt-1 text-gray-600">
//                   {proposal.governanceRemarks}
//                 </p>
//               )}
//               {proposal.governanceAt && (
//                 <p className="text-xs text-gray-400 mt-1">
//                   {new Date(proposal.governanceAt).toLocaleString()}
//                 </p>
//               )}
//             </div>
//           </CardContent>
...
// import { Badge } from "@/components/ui/badge";
// import { Button } from "@/components/ui/button";
// import { AlertTriangle, ArrowLeft, FileText, CheckCircle } from "lucide-react";
