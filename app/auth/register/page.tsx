...
export default function RegisterPage() {
  ...
  // -----------------------
  return (
    <div className="min-h-screen bg-gray-50 mt-10 mb-10 flex items-center justify-center px-4">
      <Card className="w-full max-w-md shadow-lg border border-gray-200">
        ...
        <div className="relative">
          ...
          >
            ...
            >
              <img
                src="https://ymrzppmnwkodgjfaikne.supabase.co/storage/v1/object/public/starknet_indemnify_bucket/google-icon-logo.svg"
                alt="Google"
                className="w-5 h-5"
              />
              <span>
